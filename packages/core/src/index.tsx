...
import { isInput, usePreventScroll } from "@/hooks/use-prevent-scroll"
import { useScaleBackground } from "@/hooks/use-scale-background"
...
>(function ({ ...rest }, ref) {
  ...
  const composedRef = useForkRef(ref, overlayRef)
  ...
  return (
    <Dialog.Backdrop
      onMouseUp={onMouseUp as React.MouseEventHandler<HTMLDivElement>}
      ref={composedRef}
      data-vaul-overlay=""
...
export type ContentProps = React.ComponentPropsWithoutRef<typeof Dialog.Popup>
...
export const Content = React.forwardRef<HTMLDivElement, ContentProps>(function (
  ...
  const composedRef = useForkRef(ref, drawerRef)
...
export function Portal(props: PortalProps) {
  ...
  return <Dialog.Portal container={container} {...portalProps} />
}
